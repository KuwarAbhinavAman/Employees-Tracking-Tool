    ...
    if not st.session_state.admin_logged_in:
        ...
        with tabs[0]:
            ...
            if not employees.empty:
                ...
                edited_df = st.data_editor(employees, num_rows="dynamic", width='stretch', hide_index=False, column_config={
        ...
        with tabs[1]:
            ...
            if not attendance.empty:
                ...
                edited_df = st.data_editor(attendance, num_rows="dynamic", width='stretch', hide_index=False, column_config={
        ...
        with tabs[2]:
            ...
            if not tasks.empty:
                ...
                edited_df = st.data_editor(tasks, num_rows="dynamic", width='stretch', hide_index=False, column_config={
        ...
        with tabs[3]:
            ...
            if not expenses.empty:
                ...
                edited_df = st.data_editor(expenses, num_rows="dynamic", width='stretch', hide_index=False, column_config={
        ...
        with tabs[4]:
            ...
            if not revenues.empty:
                ...
                edited_df = st.data_editor(revenues, num_rows="dynamic", width='stretch', hide_index=False, column_config={
